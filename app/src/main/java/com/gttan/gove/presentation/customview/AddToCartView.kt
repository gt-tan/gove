package com.gttan.gove.presentation.customview
...
import com.gttan.gove.databinding.ViewAddToCartBinding
...
class AddToCartView @JvmOverloads constructor(
    ...
    init {
        background =
            ResourcesCompat.getDrawable(resources, R.drawable.bg_add_to_cart_view, context.theme)
